  ...
  return (
    <section id="rsvp" className="grid grid-cols-1 md:grid-cols-2">
      <div className="bg-[#EDE8DD] px-10 py-16 md:px-14 flex flex-col justify-center">
        <span className="label">Kindly Reply</span>
        ...
        <p style={{fontSize:'0.6rem', textTransform:'uppercase', letterSpacing:'0.2em', color:'#8A7A55', marginBottom:'2rem'}}>
          Reply before · 30 April 2026
        </p>
        {submitted ? (
          <div>
            <p style={{fontFamily:'var(--font-serif)', fontStyle:'italic', fontSize:'1.75rem', color:'#3A3328', marginBottom:'0.75rem'}}>Thank you!</p>
            <p style={{fontSize:'0.85rem', color:'#5C5248', lineHeight:1.8}}>We&apos;ve received your response and can&apos;t wait to celebrate with you.</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <input name="dietary" type="text" placeholder="Dietary requirements (if any)"
